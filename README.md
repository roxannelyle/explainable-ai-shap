...
![Residual and error analysis](residual_error_analysis.png)
...
![Global SHAP feature importance](global_shap_importance.png)
...
![SHAP summary plot](shap_summary_direction.png)
...
![Median income SHAP dependence](medinc_dependence.png)
...
![Typical-error local SHAP waterfall](local_typical_error_waterfall.png)

### Largest underprediction

![Largest underprediction local SHAP waterfall](local_largest_underprediction_waterfall.png)

### Largest overprediction

![Largest overprediction local SHAP waterfall](local_largest_overprediction_waterfall.png)
...
![Comparison of feature-importance methods](importance_method_comparison.png)
